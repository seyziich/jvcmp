...
void InitSettings()
{
	...
	//MessageBox(GetActiveWindow(),GetCommandLineA(),"",0);
	memset(&tSettings,0,sizeof(GAME_SETTINGS));
	strcpy(tSettings.szNickName,"lucasc190");
	strcpy(tSettings.szConnectHost,"121.220.140.254");
	strcpy(tSettings.szConnectPort,"5192");
